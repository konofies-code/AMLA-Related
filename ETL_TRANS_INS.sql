...
SELECT  
	 [TXNDATE], [TXNREFNO], TXNTYPE, [TXNSUBTYPE], [TXNMODE], [TXNAMOUNT], [INOUT], a.[BRANCHCODE], a.[CURRENCY], [EXCHANGERATE], [PURPOSE], [CPNAME1], 
	 a.[IMPORTED_DATE], [CPNAME2], [CPNAME3], [CPINSTITUTION], [CPINSTITUTIONCOUNTRY], [CPADDRESS1], [CPADDRESS2], [CPADDRESS3], [CORRESPONDENTBANK], 
	 [CORRESBANKCOUNTRYCODE], [CORRESBANKADDRESS1], [CORRESBANKADDRESS2], [CORRESBANKADDRESS3], [INTERMEDIATORYINST], [INTERMEDIATORYINSTCOUNTRY], 
	 ...
	 [FUNDSSOURCE], [FXAMOUNT], [POSTINGGROUPID], [POSTINGSEQNO], a.[SOURCE], [INPUTDATE], [CERTIFIEDDOCUMENTS], [REGULARDOCUMENTS], [TXNFORBRANCH], 
	 [BSRCODE], [DEBIT_CREDIT], [BENEFICIARYNAME1], [BENEFICIARYNAME2], [BENEFICIARYNAME3], [BENEFICIARYADDRESS1], [BENEFICIARYADDRESS2], [BENEFICIARYADDRESS3], 
	 a.[ACCOUNTID], [REMARKS], [OPBRANCHNAME], [OPACCOUNTNO], [DEALNO], [SRCTXNTYPE], [OTHERACCOUNT], [BENEFICIARY_TINNO], [BENEFICIARYCOUNTRY], [REASONCODE], 
	 a.[FIRST_IMPORTED_DATE], [SRC_TXN_REFNO], [cpaccountno], a.[EXPORTED_DATE], a.[ETL_FLAG], [pop_benificiaryaddress], [pop_benificiaryBOD], [OTHERACCOUNTNO], 
	 [SBCRefNoDetail], [OTHERACCOUNTBRANCH], [pop_benificiary], [SBCREFNO], [PO_GROUPID], [SRC_TXNTYPE], [customerno], [CardNumber], a.[AccountNumber], 
	 [STOCKREFNO], [AMOUNTOFCLAIM], [NOOFSHARES], [NETASSETVALUE], [BENEFICIARY_CUSTOMERREFNO], [BENEFICIARY_ACCOUNTNO], [BENEFICIARY_DATEOFBIRTH], 
	 [BENEFICIARY_PLACEOFBIRTH], [BENEFICIARY_IDType], [BENEFICIARY_IDNo], [BENEFICIARY_TelNo]     ,[BENEFICIARY_NatureofBusiness], [SUSPICION_CUSTOMERREFNO], 
	 [SUSPICION_NAME1], [SUSPICION_NAME2], [SUSPICION_NAME3], [SUSPICION_ADDRESS1], [SUSPICION_ADDRESS2], [SUSPICION_ADDRESS3], [SUSPICION_ACCOUNTNO], 
	 [SUSPICION_DATEOFBIRTH], [SUSPICION_PLACEOFBIRTH], [SUSPICION_NATIONALITY], [SUSPICION_IDType], [SUSPICION_IDNo]     ,[SUSPICION_TelNo], 
	 [SUSPICION_NatureofBusiness], [TRANSACTOR_CUSTOMERREFNO], [TRANSACTOR_NAME1], [TRANSACTOR_NAME2], [TRANSACTOR_NAME3], [TRANSACTOR_ADDRESS1], 
	 [TRANSACTOR_ADDRESS2], [TRANSACTOR_ADDRESS3], [TRANSACTOR_ACCOUNTNO], [CPCUSTOMERREFNO], [OP_CUSTOMERREFNO], [OP_NAME1], [OP_NAME2], [OP_NAME3], 
	 [OP_ADDRESS1], [OP_ADDRESS2], [OP_ADDRESS3], [ISSUER_CUSTOMERREFNO], [ISSUER_NAME1], [ISSUER_NAME2], [ISSUER_NAME3], [ISSUER_ADDRESS1], [ISSUER_ADDRESS2], 
	 [ISSUER_ADDRESS3], [ISSUER_ACCOUNTNO], [BENEFICIARY_NAME_FLAG], [CP_NAME_FLAG], [OP_NAME_FLAG], [ISSUER_NAME_FLAG], [TRANSACTOR_NAME_FLAG], 
	 [SUSPICIOUS_ACTIVITY_CODE], [CPCUSTTYPE], [REGION], [TXN_DATE_TIME], a.[RUNID]   ,a.[RUNDATE],LAST_RENEWED_DATE,ACCOUNT_OPENED_dATE
INTO AML_TEMP_TRANS 
...
select 
	 [TXNDATE], [TXNREFNO], 'DTDPM' AS TXNTYPE, [TXNSUBTYPE], [TXNMODE], [TXNAMOUNT], [INOUT], a.[BRANCHCODE], a.[CURRENCY], [EXCHANGERATE], [PURPOSE], [CPNAME1], 
	 a.[IMPORTED_DATE], [CPNAME2], [CPNAME3], [CPINSTITUTION], [CPINSTITUTIONCOUNTRY], [CPADDRESS1], [CPADDRESS2], [CPADDRESS3], [CORRESPONDENTBANK], 
	 [CORRESBANKCOUNTRYCODE], [CORRESBANKADDRESS1], [CORRESBANKADDRESS2], [CORRESBANKADDRESS3], [INTERMEDIATORYINST], [INTERMEDIATORYINSTCOUNTRY], 
	 [INTERMEDIATORYINSTADDRESS1], [INTERMEDIATORYINSTADDRESS2], [INTERMEDIATORYINSTADDRESS3], [PRODUCTTYPE], [PRODUCTOWNERNAME1], [PRODUCTOWNERNAME2], 
	 [PRODUCTOWNERNAME3], [PRODUCTOWNERADDRESS1], [PRODUCTOWNERADDRESS2], [PRODUCTOWNERADDRESS3], [INCEPTIONDATE], [MATUITYDATE], [NARRATION], [TXNNATURE], 
	 [FUNDSSOURCE], [FXAMOUNT], [POSTINGGROUPID], [POSTINGSEQNO], a.[SOURCE], [INPUTDATE], [CERTIFIEDDOCUMENTS], [REGULARDOCUMENTS], [TXNFORBRANCH], [BSRCODE], 
	 [DEBIT_CREDIT], [BENEFICIARYNAME1], [BENEFICIARYNAME2], [BENEFICIARYNAME3], [BENEFICIARYADDRESS1], [BENEFICIARYADDRESS2], [BENEFICIARYADDRESS3], 
	 a.[ACCOUNTID], [REMARKS], [OPBRANCHNAME], [OPACCOUNTNO], [DEALNO], [SRCTXNTYPE], [OTHERACCOUNT], [BENEFICIARY_TINNO], [BENEFICIARYCOUNTRY], [REASONCODE], 
	 a.[FIRST_IMPORTED_DATE], [SRC_TXN_REFNO], [cpaccountno], a.[EXPORTED_DATE], a.[ETL_FLAG], [pop_benificiaryaddress], [pop_benificiaryBOD], [OTHERACCOUNTNO], 
	 [SBCRefNoDetail], [OTHERACCOUNTBRANCH], [pop_benificiary], [SBCREFNO], [PO_GROUPID], [SRC_TXNTYPE], [customerno], [CardNumber], a.[AccountNumber], 
	 [STOCKREFNO], [AMOUNTOFCLAIM], [NOOFSHARES], [NETASSETVALUE], [BENEFICIARY_CUSTOMERREFNO], [BENEFICIARY_ACCOUNTNO], [BENEFICIARY_DATEOFBIRTH], 
...
from ETL_AML_TRANSACTION a
	left join aml_account b on a.AccountNumber = b.ACCOUNTNUMBER 
where txntype = 'cpmd' 
	and b.ACCOUNTTYPE in ('901','902','903','904','906','907','908','909','911','912','913','914');
...
INSERT INTO AML_TEMP_TRANS
SELECT * 
FROM ETL_AML_TRANSACTION EAT
WHERE TXNTYPE LIKE '%TD%' 
	AND TXNAMOUNT > 500000 
	AND NOT EXISTS (
		SELECT 1 
		FROM ETL_AML_TRANSACTION ET
		WHERe ET.TXNTYPE LIKE '%TD%'
		GROUP BY ET.ACCOUNTNUMBER, ET.TXNDATE
		HAVING COUNT(*) > 1
		AND ET.ACCOUNTNUMBER = EAT.AccountNumber
	);
				...
				(
					...
					(
						...
						(
							select 1
							from ETL_AML_TRANSACTION ET
							where txntype like '%td%' and txnamount > 500000
							group by AccountNumber
							HAVING COUNT(accountnumber) = 3 AND ET.AccountNumber = EAT.AccountNumber
						) and EAT.txntype like '%td%' and EAT.txnamount > 500000 AND EAT.TXNSUBTYPE = 'PMT' and EAT.producttype <> 'ftrq'
					) a
					where rn > 2
...
select 
(SELECT isnull(max(txnid), 0) from AML_TRANSACTION) + ROW_NUMBER() OVER (ORDER BY A.TXNREFNO) AS TXNID,
